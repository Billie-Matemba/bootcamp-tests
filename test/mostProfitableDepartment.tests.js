describe('mostProfitableDepartment Test' , function(){
    it('should return outdoor as the most profitable depertment when called with "salesData"' , function(){
    ...
    it('should return "electronics" as the most profitable depertment when called with "salesData2"' , function(){
